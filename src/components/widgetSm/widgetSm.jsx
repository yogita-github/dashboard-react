        ...
        <ul className="widgetSmList">
            <li className="widgetSmListItem">
                ...
                <div className="widgetSmUser">
                    <span className="widgetSmUsername">Vijay Singh</span>
            ...
            <li className="widgetSmListItem">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoKJPxxwPeNvISnBbZsZHe887Ws0FnrL7o0w&usqp=CAU" alt="" className="widgetSmImg" />
                <div className="widgetSmUser">
                    <span className="widgetSmUsername">Harry William </span>
                    <span className="widgetSmUserTitle">Bank Manager</span>
                </div>
                <button className="widgetSmButton">
                    <Visibility/>
                    Display
            ...
            <li className="widgetSmListItem">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRajqD79cWlZzwzdrDHTCc9PfHuCwFZSSQb0Q&usqp=CAU" alt="" className="widgetSmImg" />
                <div className="widgetSmUser">
                    <span className="widgetSmUsername">Ajay Khan</span>
            ...
            <li className="widgetSmListItem">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTu7fWIFm7j2Oz0gFHTNp1fskSWJDbi_EUD2Q&usqp=CAU" alt="" className="widgetSmImg" />
                <div className="widgetSmUser">
                    <span className="widgetSmUsername">Smit Adams</span>
            ...
            <li className="widgetSmListItem">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKvbcMlnxSIWIGaols4Mns0s6e4sZmRftSoA&usqp=CAU" alt="" className="widgetSmImg" />
                <div className="widgetSmUser">
                    <span className="widgetSmUsername">Akash Chavan</span>
